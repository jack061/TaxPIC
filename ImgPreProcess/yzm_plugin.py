...
class JsdmYzmPlugin(YzmBase):
    ...
    def report(self,bOK):
        ...
        dataPost = json.dumps(data)
        ret = d.request_data_from_url('https://v2-api.jsdama.com/report-error','post',dataPost,timeout= -1)
        print (ret)
